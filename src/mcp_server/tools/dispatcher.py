...
from mcp_server.tools.youtube_composed import build_channels_get_channel_tool_descriptor, build_transcripts_get_transcript_tool_descriptor, build_videos_get_video_tool_descriptor, build_videos_search_videos_tool_descriptor
...
class InMemoryToolDispatcher:
    ...
    def _baseline_tool_definitions(self):
        ...
        return [
            ...
            build_members_list_tool_descriptor(**oauth_dependencies),
            build_memberships_levels_list_tool_descriptor(**oauth_dependencies),
            build_playlist_images_list_tool_descriptor(**oauth_dependencies),
            build_playlist_items_list_tool_descriptor(**api_key_dependencies),
            build_playlists_list_tool_descriptor(**conditional_dependencies),
            build_playlists_insert_tool_descriptor(**oauth_dependencies),
            build_playlists_update_tool_descriptor(**oauth_dependencies),
            build_playlists_delete_tool_descriptor(**oauth_dependencies),
            build_search_list_tool_descriptor(**conditional_dependencies),
            build_subscriptions_delete_tool_descriptor(**oauth_dependencies),
            build_subscriptions_insert_tool_descriptor(**oauth_dependencies),
            build_subscriptions_list_tool_descriptor(**conditional_dependencies),
            ...
            build_videos_rate_tool_descriptor(**oauth_dependencies),
            build_videos_get_rating_tool_descriptor(**oauth_dependencies),
            build_videos_report_abuse_tool_descriptor(**oauth_dependencies),
            build_videos_delete_tool_descriptor(**oauth_dependencies),
            build_playlist_items_insert_tool_descriptor(**oauth_dependencies),
            build_playlist_items_update_tool_descriptor(**oauth_dependencies),
            build_playlist_items_delete_tool_descriptor(**oauth_dependencies),
            build_playlist_images_insert_tool_descriptor(**oauth_dependencies),
            build_playlist_images_update_tool_descriptor(**oauth_dependencies),
            build_playlist_images_delete_tool_descriptor(**oauth_dependencies),
            build_guide_categories_list_tool_descriptor(**api_key_dependencies),
            build_i18n_languages_list_tool_descriptor(**api_key_dependencies),
            build_i18n_regions_list_tool_descriptor(**api_key_dependencies),
        ]
