...
from mcp_server.integrations.resources.consumers.activities import (
    ActivitiesConsumerMixin,
)
from mcp_server.integrations.resources.consumers.captions import CaptionsConsumerMixin
from mcp_server.integrations.resources.consumers.channel_banners import (
    ChannelBannersConsumerMixin,
)
from mcp_server.integrations.resources.consumers.channel_sections import (
    ChannelSectionsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.channels import ChannelsConsumerMixin
from mcp_server.integrations.resources.consumers.comment_threads import (
    CommentThreadsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.comments import CommentsConsumerMixin
from mcp_server.integrations.resources.consumers.guide_categories import (
    GuideCategoriesConsumerMixin,
)
from mcp_server.integrations.resources.consumers.localization import (
    LocalizationConsumerMixin,
)
from mcp_server.integrations.resources.consumers.members import MembersConsumerMixin
from mcp_server.integrations.resources.consumers.memberships_levels import (
    MembershipsLevelsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.playlist_images import (
    PlaylistImagesConsumerMixin,
)
from mcp_server.integrations.resources.consumers.playlist_items import (
...
from mcp_server.integrations.resources.consumers.subscriptions import (
    SubscriptionsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.thumbnails import (
    ThumbnailsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.video_abuse_report_reasons import (
    VideoAbuseReportReasonsConsumerMixin,
)
from mcp_server.integrations.resources.consumers.video_categories import (
    VideoCategoriesConsumerMixin,
)
from mcp_server.integrations.resources.consumers.videos import VideosConsumerMixin
from mcp_server.integrations.resources.consumers.watermarks import (
