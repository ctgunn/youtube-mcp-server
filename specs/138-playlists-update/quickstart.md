# Quickstart: YT-138 Layer 1 Endpoint `playlists.update`

## Goal

Use this feature to add a reviewable internal `playlists.update` wrapper on top of the existing Layer 1 foundation, with clear quota visibility, explicit writable `snippet` guidance, visible OAuth-only expectations, deterministic rejection of unsupported request combinations, and normalized update outcomes suitable for downstream reuse.

## 1. Review the feature artifacts

- Read the specification: [/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/spec.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/spec.md)
- Read the implementation plan: [/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/plan.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/plan.md)
- Read the research decisions: [/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/research.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/research.md)
- Read the wrapper contract: [/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/contracts/layer1-playlists-update-wrapper-contract.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/contracts/layer1-playlists-update-wrapper-contract.md)
- Read the auth and write-boundary contract: [/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/contracts/layer1-playlists-update-auth-write-contract.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/138-playlists-update/contracts/layer1-playlists-update-auth-write-contract.md)

## 2. Implement in Red-Green-Refactor order

1. Add failing unit tests for `playlists.update` metadata completeness, quota visibility, writable-input validation, target-identifier enforcement, and OAuth-only enforcement.
2. Add failing transport tests for request construction and normalized result handling for valid, invalid, unauthorized, and upstream-rejected playlist-update profiles.
3. Add failing integration and contract tests showing the representative wrapper path does not yet make `playlists.update` reusable for higher-layer planning.
...
- Keep YT-138 internal-only.
- Do not add a public `playlists_update` MCP tool in this slice.
...
- `playlists.update` wrapper metadata shows endpoint identity and the quota cost of `50`
- Required writable `snippet` inputs are clear
- Higher-layer playlist-update summaries show required fields, the active writable part, the required playlist identifier, and the required nested title field
...
- Missing playlist identifier or title input fails clearly
