# Specification Quality Checklist: Layer 2 Tool `guideCategories_list`
...
- Local collision evidence before branch creation: no local branches matching `223-*` and no existing directories matching `specs/223-*`.
