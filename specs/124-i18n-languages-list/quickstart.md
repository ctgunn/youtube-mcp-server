# Quickstart: YT-124 Layer 1 Endpoint `i18nLanguages.list`

## Goal

Add a reviewable internal `i18nLanguages.list` wrapper on top of the existing Layer 1 foundation with explicit `part` plus `hl` rules, API-key visibility, localization-lookup guidance, quota visibility, and normalized retrieval outcomes suitable for downstream reuse.

## 1. Review the feature artifacts

- Read the specification: [/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/spec.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/spec.md)
- Read the implementation plan: [/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/plan.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/plan.md)
- Read the research decisions: [/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/research.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/research.md)
- Read the wrapper contract: [/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/contracts/layer1-i18n-languages-list-wrapper-contract.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/contracts/layer1-i18n-languages-list-wrapper-contract.md)
- Read the localization contract: [/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/contracts/layer1-i18n-languages-list-localization-contract.md](/Users/ctgunn/Projects/youtube-mcp-server/specs/124-i18n-languages-list/contracts/layer1-i18n-languages-list-localization-contract.md)

## 2. Implement in Red-Green-Refactor order

1. Add failing unit tests for `i18nLanguages.list` metadata completeness, quota visibility, and required `part` plus `hl` validation.
2. Add failing transport tests for request construction and normalized result handling for valid, invalid, and empty-result localization-language profiles.
...
- Keep YT-124 internal-only.
- Do not add a public `i18nLanguages_list` MCP tool in this slice.
...
- `i18nLanguages.list` wrapper metadata shows endpoint identity and quota cost `1`
...
- Localization-lookup guidance is visible in wrapper and higher-layer review surfaces
