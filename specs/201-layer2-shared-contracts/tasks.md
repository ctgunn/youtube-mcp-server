# Tasks: YT-201 Layer 2 Shared Scaffolding and Contracts
...
**Organization**: Tasks are grouped by user story to enable independent implementation and testing. US1 is the MVP because it establishes the shared Layer 2 contract records and naming rules that later endpoint slices depend on.

## Phase 1: Setup (Shared Infrastructure)

**Purpose**: Establish the shared Layer 2 package and empty test files without adding endpoint behavior.

- [X] T001 Create shared Layer 2 package directory and empty package initializer in `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/__init__.py`
- [X] T002 [P] Create empty shared contract test file in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py`
- [X] T003 [P] Create empty shared scaffolding unit test file in `/Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py`
- [X] T004 [P] Create empty Layer 2 registration integration test file in `/Users/ctgunn/Projects/youtube-mcp-server/tests/integration/test_layer2_tool_registration.py`
- [X] T005 [P] Create empty Layer 2 catalog contract test file in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_tool_catalog_contract.py`
...
- [X] T010 Export placeholder shared Layer 2 symbols from `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/__init__.py`
- [X] T011 Run import smoke check from `/Users/ctgunn/Projects/youtube-mcp-server` with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py` and confirm no collection errors from the new files

**Checkpoint**: Shared Layer 2 module files exist and user story implementation can begin.

---

## Phase 3: User Story 1 - Define Shared Layer 2 Contracts Once (Priority: P1) MVP

**Goal**: Maintainers can derive and validate shared Layer 2 public tool contracts without redefining naming, upstream identity, auth, quota, caveat, input, response, or error rules per endpoint.
...
- [X] T012 [P] [US1] Add failing contract tests for required Layer 2 tool metadata fields in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py`
- [X] T013 [P] [US1] Add failing unit tests for `resource_method` name derivation, camelCase preservation, and `youtube_` prefix rejection in `/Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py`
- [X] T014 [P] [US1] Add failing contract tests for representative examples including `activities.list`, `comments.setModerationStatus`, `videos.getRating`, and `watermarks.unset` in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_tool_catalog_contract.py`

### Implementation for User Story 1

- [X] T015 [US1] Implement `Layer2ToolContract`, `AuthMode`, and `Layer2ContractError` primitives in `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/contracts.py`
...
- [X] T021 [US1] Run focused US1 checks from `/Users/ctgunn/Projects/youtube-mcp-server` with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py tests/contract/test_layer2_shared_contract.py tests/contract/test_layer2_tool_catalog_contract.py`
...
**Checkpoint**: User Story 1 is independently testable and provides the MVP shared Layer 2 contract foundation.

---

## Phase 4: User Story 2 - Use Low-Level Tools With Predictable Semantics (Priority: P2)

**Goal**: Power users and endpoint authors can rely on consistent near-raw input, response, auth, quota, and safe error conventions across representative Layer 2 endpoint shapes.
...
- [X] T023 [P] [US2] Add failing unit tests for input convention helpers covering required fields, selector groups, `part`, pagination, request body, media, and delegation metadata in `/Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py`
- [X] T024 [P] [US2] Add failing contract tests for near-raw response conventions covering list, mutation acknowledgment, upload/media, download-safe wrapper, and lookup result kinds in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py`
- [X] T025 [P] [US2] Add failing contract tests for safe error categories and secret-leak prevention in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py`
- [X] T026 [P] [US2] Extend representative catalog tests for paginated, mutation, upload/media, high-quota, and deprecated/availability-constrained shapes in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_tool_catalog_contract.py`
...
- [X] T029 [US2] Implement safe Layer 2 error category records and detail sanitization helpers in `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/conventions.py`
...
- [X] T034 [US2] Run focused US2 checks from `/Users/ctgunn/Projects/youtube-mcp-server` with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py tests/contract/test_layer2_shared_contract.py tests/contract/test_layer2_tool_catalog_contract.py`
...
**Checkpoint**: User Stories 1 and 2 work independently and prove predictable near-raw Layer 2 semantics for representative shapes.

---

## Phase 5: User Story 3 - Keep Endpoint Tool Families Cohesive (Priority: P3)

**Goal**: Future endpoint authors can locate where Layer 2 tool definitions, input contracts, handlers, response expectations, tests, examples, and caveats belong by resource family without creating a monolithic endpoint-tool file.
...
- [X] T036 [P] [US3] Add failing unit tests for required Layer 2 resource-family names and placement metadata in `/Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py`
- [X] T037 [P] [US3] Add failing contract tests proving endpoint-specific facts stay with resource-family scaffolding while shared rules remain centralized in `/Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py`
- [X] T038 [P] [US3] Add failing integration tests for registering representative Layer 2 tool descriptors with the existing dispatcher without endpoint execution in `/Users/ctgunn/Projects/youtube-mcp-server/tests/integration/test_layer2_tool_registration.py`

### Implementation for User Story 3

- [X] T039 [US3] Implement `Layer2ResourceFamily` and required family registry helpers in `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/families.py`
...
- [X] T045 [US3] Run focused US3 checks from `/Users/ctgunn/Projects/youtube-mcp-server` with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py tests/contract/test_layer2_shared_contract.py tests/integration/test_layer2_tool_registration.py`
...
- [X] T048 [P] Update public tool contract notes if implementation changed shared naming, metadata, response, or error wording in `/Users/ctgunn/Projects/youtube-mcp-server/specs/201-layer2-shared-contracts/contracts/layer2-public-tool-contract.md`
- [X] T049 [P] Update scaffolding contract notes if implementation changed family placement or test-location guidance in `/Users/ctgunn/Projects/youtube-mcp-server/specs/201-layer2-shared-contracts/contracts/layer2-scaffolding-contract.md`
...
- [X] T051 Run all focused Layer 2 tests from `/Users/ctgunn/Projects/youtube-mcp-server` with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py tests/contract/test_layer2_shared_contract.py tests/contract/test_layer2_tool_catalog_contract.py tests/integration/test_layer2_tool_registration.py` and fix failures in affected files
...
```bash
Task: "T012 [US1] Add failing contract tests for required Layer 2 tool metadata fields in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py"
Task: "T013 [US1] Add failing unit tests for resource_method name derivation in /Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py"
Task: "T014 [US1] Add failing contract tests for representative examples in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_tool_catalog_contract.py"
```

## Parallel Example: User Story 2

```bash
Task: "T023 [US2] Add failing unit tests for input convention helpers in /Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py"
Task: "T024 [US2] Add failing contract tests for response conventions in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py"
Task: "T025 [US2] Add failing contract tests for safe error categories in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py"
Task: "T026 [US2] Extend representative catalog tests in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_tool_catalog_contract.py"
```

## Parallel Example: User Story 3

```bash
Task: "T036 [US3] Add failing unit tests for required Layer 2 resource-family names in /Users/ctgunn/Projects/youtube-mcp-server/tests/unit/test_layer2_shared_scaffolding.py"
Task: "T037 [US3] Add failing contract tests for family/shared boundary rules in /Users/ctgunn/Projects/youtube-mcp-server/tests/contract/test_layer2_shared_contract.py"
Task: "T038 [US3] Add failing integration tests for representative descriptor registration in /Users/ctgunn/Projects/youtube-mcp-server/tests/integration/test_layer2_tool_registration.py"
```
...
4. Stop and validate with `python3 -m pytest tests/unit/test_layer2_shared_scaffolding.py tests/contract/test_layer2_shared_contract.py tests/contract/test_layer2_tool_catalog_contract.py` from `/Users/ctgunn/Projects/youtube-mcp-server`
5. Demo MVP by deriving names and validating representative Layer 2 contracts without adding endpoint behavior

### Incremental Delivery

1. Setup and Foundational phases create the shared Layer 2 package
