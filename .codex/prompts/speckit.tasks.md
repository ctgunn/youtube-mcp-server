...
4. **Generate tasks.md**: Use `.specify/templates/tasks-template.md` as structure, fill with:
   ...
   - Each phase includes: story goal, independent test criteria, Red/Green/Refactor test tasks, implementation tasks
...
1. **From User Stories (spec.md)** - PRIMARY ORGANIZATION:
   ...
   - Map all related components to their story:
     ...
     - Tests specific to that story (Red before Green, then Refactor)
...
- **Phase 3+**: User Stories in priority order (P1, P2, P3...)
  - Within each story: Red tests → Green implementation → Refactor → Integration validation
