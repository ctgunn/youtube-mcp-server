...
class IaCFoundationContractTests(unittest.TestCase):
    ...
    def test_gcp_infrastructure_files_define_required_foundation_components(self):
        ...
        network = Path("infrastructure/gcp/network.tf").read_text()
        ...
        self.assertIn("google_compute_network", network)
        self.assertIn("google_compute_subnetwork", network)
        self.assertIn("google_vpc_access_connector", network)
        ...
        self.assertIn('output "mcp_session_network_reference"', outputs)
        self.assertIn('output "mcp_session_subnet_reference"', outputs)
        self.assertIn('output "mcp_session_connector_reference"', outputs)
        self.assertNotIn('variable "cloud_run_vpc_connector"', variables)
        self.assertNotIn('variable "redis_authorized_network"', variables)
