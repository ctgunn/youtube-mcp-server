...
- N/A for feature-specific persistence; wrapper metadata, request validation state, moderation execution state, and feature artifacts remain in-memory or file-based only (119-comments-set-moderation-status)
- N/A for feature-specific persistence; wrapper metadata, request validation state, delete execution state, and feature artifacts remain in-memory or file-based only (120-comments-delete)
...
- N/A for feature-specific persistence; wrapper metadata, request validation state, and subscription-delete execution state remain in-memory or file-based only (143-subscriptions-delete)
...
## Recent Changes
- 208-captions-delete: Added Python 3.11 + Existing MCP tool registry and dispatcher under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/`; existing shared Layer 2 contract primitives under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/`; existing Layer 1 `captions.delete` wrapper and resource metadata under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/integrations/resources/captions.py`; Python standard library dataclasses, enums, and JSON-compatible dictionaries; pytest; Ruff
- 207-captions-download: Added Python 3.11 + Existing MCP tool registry and dispatcher under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/`; existing shared Layer 2 contract primitives under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/`; existing Layer 1 `captions.download` wrapper and resource metadata under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/integrations/resources/captions.py`; Python standard library dataclasses, enums, and JSON-compatible dictionaries; pytest; Ruff
- 206-captions-update: Added Python 3.11 + Existing MCP tool registry and dispatcher under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/`; existing shared Layer 2 contract primitives under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/tools/youtube_common/`; existing Layer 1 `captions.update` wrapper and resource metadata under `/Users/ctgunn/Projects/youtube-mcp-server/src/mcp_server/integrations/resources/captions.py`; Python standard library dataclasses, enums, and JSON-compatible dictionaries; pytest; Ruff
