...
- Retry behavior MUST use bounded exponential backoff and honor applicable upstream retry guidance. It MUST NOT automatically replay a non-idempotent mutation after an ambiguous failure unless the operation has a documented safe recovery or idempotency strategy.
